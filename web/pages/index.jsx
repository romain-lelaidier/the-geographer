...
import { u, uLogOut } from '../api/auth';
import { Layout } from '../components/layout';
import { LinkIcon, mds, User } from "../components/utils";
  ...
  return (
    <Layout center={true}>
      ...
      <div class="flex flex-col items-center gap-8 text-xl text-center">
        ...
        <Show
          when={u.connected}
          fallback={<div class="flex gap-2"><LinkIcon href="login" type="right-to-bracket" text="log in"/> or <LinkIcon href="signup" type="paw" text="register"/></div>}
        >
          <div class="flex flex-col items-center">
            ...
            <div class="font-bold flex flex-row gap-2 [&>a]:text-white [&>a]:text-shadow">
              ...
              {/* <LinkIcon href="profile" type="dna" text="profile"/>{mds} */}
        ...
        <div style={`width: ${playblockState() ? 30 : 10}em`} class="max-w-full bg-white rounded-lg h-34 max-h-34 overflow-hidden flex flex-row items-center justify-center transition-all ease duration-300" onClick={() => setPlaylblockState(true)}>
          <Show when={playblockState() == true} fallback={<div class="flex flex-row gap"><LinkIcon href="" type="chess-knight" text="play"/></div>}>
        ...
        <LinkIcon href="./leaderboards" type="ranking-star" text="leaderboards"/>
